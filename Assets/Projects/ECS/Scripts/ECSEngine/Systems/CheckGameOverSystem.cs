...
namespace ECSHomework
{
    ...
    {
        private readonly EcsFilterInject<Inc<EntityObject, Inactive, IsBase>> _deadFilter;
        
        private readonly EcsFilterInject<Inc<EntityObject>, Exc<Inactive, DeathRequest, GameOver>> _aliveEntitiesFilter;
